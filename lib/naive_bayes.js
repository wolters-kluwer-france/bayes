 ...
 */
Naivebayes.prototype.categorize = function(text, nb) {
    var self = this,
        maxProbability = -Infinity,
        chosenCategory = [];

    if (typeof nb == 'undefined' || nb == 0) {
        nb = 1;
    }
    ...
    if (nb == 1) {
        return chosenCategory.shift();
    }
    return chosenCategory.slice(0, nb);
}
